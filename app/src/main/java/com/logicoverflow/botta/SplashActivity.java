...
import com.logicoverflow.botta.Util.AndroidAnimationBuilder;
...
public class SplashActivity extends AppCompatActivity {
    ...
    public void animate() {
        ...
        new AndroidAnimationBuilder(logo_image).setDefaultStepDuration(1200)
        ...
        new AndroidAnimationBuilder(logo_text)
                // first step: quick preparations.
                .alpha(0).ms(10).then().pause(600).setDefaultStepDuration(500)
                .then().alpha(1).reset()
                .execute();

        new AndroidAnimationBuilder(progressBar)
                // first step: quick preparations.
                .alpha(0).ms(10).then().pause(1200).setDefaultStepDuration(500)
                .then().alpha(1).reset()
                .execute();
